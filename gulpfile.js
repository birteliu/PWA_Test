...
const build = gulp.parallel(basisCopy, copyPWA, copySW, css, images, js, layout());
const dev = gulp.series(clean, build, browserSync, watchFiles)
const watch = gulp.series(clean,gulp.parallel(basisCopy, copyPWA, copySW, css, images, js), copy, watchFiles_copy);
// 一般開發輸出
//gulp.series(照順序執行)
//gulp.parallel(同時執行)
